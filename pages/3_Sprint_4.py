...
st.set_page_config(
    page_title="Sprint 4 - Monitoring",
    page_icon="📊",
    layout="wide"
)
...
with tab2:
    ...
    grafana_path = Path(__file__).parent.parent / "captures" / "grafana_dashboard.png"
    st.image(str(grafana_path), caption="Dashboard Grafana - RecoFilm Monitoring", width=1200)
...
with tab3:
    ...
    evidently_path = Path(__file__).parent.parent / "captures" / "evidently_drift.png"
    st.image(str(evidently_path), caption="Rapport Evidently - Data Drift Detection", width=2300)

"""
app.py
API FastAPI pour entraîner le modèle de recommandation SVD avec PostgreSQL
"""
...
# -----------------------------
app = FastAPI(title="Entrainement model - Recommandation Film API")
...
def load_model():
    """
    Charge le modèle SVD en Production depuis le repertoire models.
